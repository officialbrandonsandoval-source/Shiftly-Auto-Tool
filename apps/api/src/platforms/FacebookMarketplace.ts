...
export interface FacebookMarketplaceCredentials {
  ...
  pageId?: string // Facebook page ID (optional, defaults to user's primary page)
}
...
export async function postToMarketplace(
  credentials: FacebookMarketplaceCredentials,
  listing: FacebookMarketplacePost
 ...
 */
export async function validateAccessToken(credentials: FacebookMarketplaceCredentials): Promise<boolean> {
  return new Promise((resolve) => {
    try {
