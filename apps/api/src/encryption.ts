 ...
 */
export function encrypt(plaintext: string, masterSecret: string): EncryptedData {
 ...
 */
export function decrypt(encryptedData: EncryptedData, masterSecret: string): string {
  const key = deriveKey(masterSecret)
