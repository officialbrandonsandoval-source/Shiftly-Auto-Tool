...
import { hashPassword, verifyPassword, createAuthResponse, verifyToken, } from './tokenService.js';
...
router.post('/signup/dealership', async (req, res) => {
    try {
        const { dealershipName, email, password, name } = req.body;
        // Validate input
...
router.post('/invite-user', verifyApiKey, async (req, res) => {
    try {
