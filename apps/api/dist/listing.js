 ...
 */
export function generateListingPackage(vehicle) {
    ...
    if (vehicle.bodyType)
        specs['Body Type'] = vehicle.bodyType;
    if (vehicle.transmission)
        specs['Transmission'] = vehicle.transmission;
    if (vehicle.fuelType)
        specs['Fuel Type'] = vehicle.fuelType;
    if (vehicle.exteriorColor)
        specs['Exterior Color'] = vehicle.exteriorColor;
    if (vehicle.interiorColor)
        specs['Interior Color'] = vehicle.interiorColor;
...
function generateDefaultDescription(vehicle) {
